...
import 'package:rtrigger/Food/product_detail.dart';
...
class Food2Item extends StatefulWidget {
  final String title;
  final String loc;
  final String rate;
  final String detail;
  ...
  Food2Item(this.title, this.loc, this.rate, this.fav, this.detail);

  @override
  _Food2ItemState createState() => _Food2ItemState();
}

class _Food2ItemState extends State<Food2Item> {
  @override
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (_) => ProductDetail(rate: widget.rate, title: widget.title, loc: widget.loc, detail: widget.detail,)));
          },
          child: Padding(
