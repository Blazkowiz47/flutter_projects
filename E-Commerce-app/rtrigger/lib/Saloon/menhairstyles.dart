...
import 'mendetail.dart';
import 'package:flutter/material.dart';


final Color _color = Color.fromRGBO(0, 44, 64, 1);

class MenhairStyles extends StatefulWidget {
  final String title;
  final String loc;
  final String sum;
  final String location;
  final String description;
  MenhairStyles({this.title, this.loc, this.sum, this.location,this.description});

  @override
  _MenhairStylesState createState() => _MenhairStylesState();
}

class _MenhairStylesState extends State<MenhairStyles> {
  @override
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (_) => MenDetail(title: widget.title, loc: widget.loc, description: widget.description, sum: widget.sum, address: widget.location,)));
                            },
                            child: Padding(
